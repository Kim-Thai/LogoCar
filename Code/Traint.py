...
labelFile = 'C:/Users/isokids/Desktop/BaiTapLon_TTM/Code/labels.csv'# file with all names of classes
batch_size_val = 50  # how many to process together
#steps_per_epoch_val = X_train.shape[0]//BATCH_SIZE,
epochs_val = 200 # số lần train
...
model = myModel()
print(model.summary())
history = model.fit(dataGen.flow(X_train, y_train, batch_size=batch_size_val), steps_per_epoch=X_train.shape[0]//batch_size_val,
